...
public class MarcStudy : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //Start the puesdo randomised routes
        if (Input.GetKey(KeyCode.Alpha1))
        {
            ...
            //Need to use StartCoroutine for these functions, starts the auto 5 experimental puesdo routes
            StartCoroutine(RandomAuto());
        }

        //Start the original route
